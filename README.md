...
- [sekassel-research/org-repo-name-fetcher](https://github.com/sekassel-research/org-repo-name-fetcher) (4 weeks ago)- This script fetches all names with a specific prefix in an organisation.
...
- [andli/pymkm](https://github.com/andli/pymkm) ([2.0.6](https://github.com/andli/pymkm/releases/tag/2.0.6), 2 weeks ago) - Python wrapper for the cardmarket.com API. Also contains a working app with price updating of your personal stock, csv import etc.
